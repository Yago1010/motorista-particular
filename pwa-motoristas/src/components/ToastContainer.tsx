...
function ToastItem({ toast, onClose }: { toast: Toast; onClose: (id: string) => void }) {
  ...
  return (
    <div
      className={`flex items-center gap-3 px-4 py-3 rounded-xl shadow-lg min-w-[280px] max-w-md animate-slide-in pointer-events-auto ${typeClasses[toast.type]}`}
      role="alert"
      aria-live="polite"
    >
      <div className={`p-1.5 rounded-lg ${iconClasses[toast.type]}`}>
