        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <!-- Map for destination location -->
                 ...
                 <input type="text" class="form-control" name="my_address" id="my-dest" value='' placeholder="Please enter Destination address" style="margin-bottom:10px;width:65%;float:left;">
