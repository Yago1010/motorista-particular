            ...
            <input type="hidden" name="id" value="<?= $walker->id ?>">
                            ...
                            $ar=array();
                              foreach ($ps as $pss) {
                               ...
                               $servname = $types->name;
                            ?>
                                <input class="form-control" name="service[]" type="checkbox" value="{{$types->id}}" <?php if(!empty($ar)){if (in_array($servname, $ar)) echo "checked='checked'";}  ?>>{{$types->name}}<br>
                            </td>
                            <td>
                                <input class="form-control" name="service_base_price[]" type="text" value="<?php $proviserv = ProviderServices::where('provider_id',$walker->id)->where('type',$types->id)->first(); if(empty($proviserv)){echo "";}else{echo $proviserv->base_price;} ?>" placeholder="Base Price" ><br>
                            </td>
                            <td>
                                <input class="form-control" name="service_price_distance[]" type="text" value="<?php $proviserv = ProviderServices::where('provider_id',$walker->id)->where('type',$types->id)->first(); if(empty($proviserv)){echo "";}else{echo $proviserv->price_per_unit_distance;} ?>" placeholder="Price per unit distance" ><br>
                            </td>
                            <td>
                                <input class="form-control" name="service_price_time[]" type="text" value="<?php $proviserv = ProviderServices::where('provider_id',$walker->id)->where('type',$types->id)->first(); if(empty($proviserv)){echo "";}else{echo $proviserv->price_per_unit_time;} ?>" placeholder="Price per unit time" ><br>
                            </td>
                            </tr>
                               @endforeach
                            </tbody>
