        ...
        <div class="container">
          <a href="/"><img class="imghome" src="<?php echo web_url(); ?><?php echo $logo;?>" alt=""></a>
              <form class="form-login" action="{{route('/user/save')}}" method="post">
                <h2 class="form-login-heading">{{ trans('ui.register') }}</h2>
                <div class="login-wrap">
                    <input type="text" name="first_name" required class="form-control" placeholder="{{ trans('ui.first_name') }}" autofocus><br>
                    <input type="text" name="last_name" required class="form-control" placeholder="{{ trans('ui.last_name') }}" ><br>
                    <input type="text" name="phone" required class="form-control" placeholder="{{ trans('ui.mobile_number') }}" ><br>
                    <input type="text" name="email" required class="form-control" placeholder="{{ trans('ui.email_address') }}" >
                    <br>
                    <div class="password-toggle-wrap">
                      <input type="password" name="password" id="user-signup-password" required class="form-control" placeholder="{{ trans('ui.password') }}" autocomplete="new-password">
                    ...
                    <br>
                    <input type="text" name="referral_code" class="form-control" placeholder="{{ trans('ui.referral_code') }}" >
                    <br>
                    ...
                    <button id="register" class="btn btn-theme btn-block" type="submit"><i class="fa fa-lock"></i> {{ trans('ui.register') }}</button>
                    ...
                    <div class="registration">
                        {{ trans('ui.already_have_account') }}<br/>
    ...
    <script type="text/javascript">
      var tour = new Tour(
        ...
        tour.addSteps([
          {
            element: "#register", 
            title: {!! json_encode(trans('ui.tour_user_signup_title')) !!}, 
            content: {!! json_encode(trans('ui.tour_user_signup_content')) !!},
