    ...
    <div class="content-panel">
      <div class="row">
        ...
        <div class="col-md-11">
          <div class="row">
          <div class="col-md-6">
          <input type="text" class="form-control" name="my_address" id="my-address" placeholder="Please enter Source address" style="margin-bottom:10px;width:65%;float:left;">
          ...
          <input type="text" class="form-control" name="my_address" id="my-dest"  placeholder="Please enter Destination address" style="margin-bottom:10px;width:65%;float:left;">
          ...
          <form  id="request-form" style="display:none;">
            ...
            <div class="form-group">
              ...
              <select name="payment_type" class="form-control" required>
                <option value="1" <?php if($payment_option['cod']==0){echo 'hidden';} ?>>Pay by Cash</option>
                <option value="0" <?php if($payment_option['stored_cards']==0){echo 'hidden';} ?>>Pay by Stored Card</option>
                <option value="2" <?php if($payment_option['paypal']==0){echo 'hidden';} ?>>Pay by Paypal</option>
              </select>
              <br>
            </div>
            <div class="form-group">
              <?php $promosett = Settings::where('key','promo_code')->first(); if($promosett->value==1){ ?>
