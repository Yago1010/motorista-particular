        ...
        <div  class="col-md-6">
          ...
          <div class="col-md-12">
            ...
            <div class="col-lg-12" >
              ...
              <div class="col-lg-2">
                <p><a href="#"><img src="<?php if($walker->picture!=''){echo $walker->picture;}else{echo asset_url().'/web/default_profile.png';} ?>" class="img-circle" width="50"></a></p>
              </div>
              <div class="col-lg-8">
                <div class="col-lg-12">
              ...
              <form id="eta_form" style='display:none; padding-top:20px;' method="post" action="<?php echo URL::Route('etaweb') ?>">
                <input class="col-sm-12 form-control" name="mail_ids" id="mail_ids" required placeholder="Enter the Email ID's seperated with comma's(,)">
                 ...
                 <input type="hidden" name="destination" id='destination' value="<?php if($request!=''){ echo $request->D_latitude.','.$request->D_longitude; }else{echo '';} ?>">
                 <input type="hidden" name="source" id='source' value="<?php if($walker_detail!=''){echo $walker_detail->latitude.','.$walker_detail->longitude;}else{echo '';} ?>">
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    var request = {
    origin: "<?php if($request!=''){ echo $request->D_latitude.','.$request->D_longitude; }else{echo '';} ?>",
