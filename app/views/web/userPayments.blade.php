          ...
          <div class="col-lg-12" id="add-card" style="display:none;">
              <form action="{{route('userpayments')}}" method="POST" id="payment-form" class="col-lg-6">
                  ...
                  <div class="col-lg-2">
                   ...
                   <input type="text" size="4" id="cvv" data-stripe="cvc"  class="form-control" name="cvv" placeholder="CVV" />
                   <br>
                  </div>
                  </div>
                  ...
                  <div class="col-lg-12" >
                    <span class="col-lg-3">
                      <input type="text" size="2" data-stripe="exp-month" name="month" placeholder="MM" class="form-control" />
                    </span>
                    <span class="col-lg-3">
                    <input type="text" size="4" data-stripe="exp-year" name="year" placeholder="YYYY" class="form-control" />
                    </span>
                  </div>
                  <div class="col-lg-12" >
