      ...
      <header class="header black-bg">
            ...
            <div class="top-menu">
            	<ul class="nav pull-right top-menu">
                    <li style="padding-top:10px; padding-right:8px;">@include('partials.language-switcher')</li>
                    <li><a class="logout" href="{{route('/user/logout')}}">{{ trans('ui.logout') }}</a></li>
            	</ul>
            </div>
        </header>
      <!--header end-->
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="" id="flow1">
                      ...
                      <a id="request" href="{{route('userrequestTrip')}}">
                          ...
                          <span>{{ trans('ui.request_trip', array('trip' => trans('customize.Trip'))) }}</span>
                      </a>
                  </li>
