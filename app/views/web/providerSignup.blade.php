          ...
          <a href="/"><img class="imghome" src="<?php echo web_url(); ?><?php echo $logo;?>" alt=""></a>
              <form class="form-login" action="{{ URL::Route('ProviderSave') }}" method="post">
                ...
                <div class="login-wrap">
                    <input type="text" name="first_name" class="form-control" required placeholder="{{ trans('ui.first_name') }}" autofocus><br>
                    <input type="text" name="last_name" class="form-control" required placeholder="{{ trans('ui.last_name') }}" ><br>
                    <input type="text" name="phone" class="form-control" required placeholder="{{ trans('ui.mobile_number') }}" ><br>
                    ...
                    <div class="password-toggle-wrap">
                      <input type="password" name="password" id="provider-signup-password" required class="form-control" placeholder="{{ trans('ui.password') }}" autocomplete="new-password">
                    ...
                    <br>
                    <button class="btn btn-theme btn-block" type="submit" id="provider-signup"><i class="fa fa-lock"></i> {{ trans('ui.register') }}</button>
                    <hr>
                    <!--
        ...
        tour.addSteps([
          {
            ...
            title: {!! json_encode(trans('ui.tour_provider_signup_title', array('provider' => trans('customize.Provider')))) !!}, 
            content: {!! json_encode(trans('ui.tour_provider_signup_content')) !!},
