		...
		<tr>
			<td>
				<table width="660" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0" style="padding:20px;">
					...
					<img width="250" height="250" src="<?php echo $email_data['map']; ?>">
					</div>
					<?php } ?>
						<td width="100%">
							...
							<table width="300" align="left" class="resp-full-table" style="margin:0 auto;float:none;background-color:#2ecc71; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td width="100%" class="resp-full-td" valign="top" style="text-align: justify; padding:20px;">
										...
										<div style="margin: 10px 0px;font-size:16px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; color:#ffffff;"><span>Base Fare</span><span style="float:right;"><?php echo $currency->keyword.' '.$email_data['base_price']; ?></span></div>
										...
										<div style="font-weight:bold;margin: 10px 0px;font-size:16px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; color:#ffffff;"><span>Sub Total</span><span style="float:right;"> <?php echo $currency->keyword.' '.$email_data['total']; ?></span></div>
									</td>
								</tr>
							...
							<table width="100%" align="right" class="resp-full-table" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td width="100%" class="resp-full-td" valign="top" style="text-align : justify;">
										<div style="background:#2ECC71;padding: 10px;font-size:25px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#ffffff">TOTAL<span style="float:right;"><?php echo $currency->keyword.' '.$email_data['total']; ?></span></div>
									</td>
								</tr>
