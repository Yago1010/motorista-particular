                    ...
                    <div class="box box-danger">
                        ...
                        <form method="get" action="{{ URL::Route('/admin/sortpvtype') }}">
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <option value="provid" <?php if(isset($_GET['type']) && $_GET['type']=='provid') {echo 'selected="selected"';}?> id="provid">{{ trans('customize.Provider');}} Type ID</option>
                ...
                <table class="table table-bordered">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{ URL::Route('AdminProviderTypeEdit', $type->id) }}"><input type="button" class="btn btn-success" value="Edit"></a>
                                        <?php if(!$type->is_default){ ?><a href="{{ URL::Route('AdminProviderTypeDelete', $type->id) }}"><input type="button" class="btn btn-danger" value="Delete"></a><?php } ?></td>
                                    </tr>
                                    <?php } ?>
                    </tbody>
                </table>
