...
<div class="row">
                        <div class="col-lg-6 col-xs-6">
                            ...
                            <div class="small-box bg-aqua">
                                <div class="inner">
                                    <h3>
                                       <?php $owner = Owner::where('id',$request->owner_id)->first(); if($owner != NULL){ echo $owner->first_name.' '.$owner->last_name; } ?>
                                    </h3>
                                    <p>
                                        User
                                    </p>
                        ...
                        <div class="col-lg-6 col-xs-6">
                            ...
                            <div class="small-box bg-yellow">
                                <div class="inner">
                                    <h3>
                                       <?php $walker = Walker::where('id',$request->confirmed_walker)->first(); if($walker != NULL){ echo $walker->first_name.' '.$walker->last_name; } ?>
                                    </h3>
                                    <p>
                                        Providers
                                    </p>
