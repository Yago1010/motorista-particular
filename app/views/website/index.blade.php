                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav social hidden-xs hidden-sm">
                            <li><a href="https://twitter.com/mowares"><i class="fa fa-twitter fa-lg fa-fw"></i></a></li>
                            <li><a href="https://www.facebook.com/MOWARES"><i class="fa fa-facebook fa-lg fa-fw"></i></a></li>
                        </ul>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-10 col-md-push-1">
                        ...
                        <h4>Demo lets you test out the amazing Taxi Now app.<br>
        ...
        <section id="settings">
            <div class="container">
                <div class="col-md-7">
                    ...
                    <h2 class="scrollpoint sp-effect3">Taxi Now <span>App</span></h2>
        ...
        <section id="screenshots">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="section-heading scrollpoint sp-effect3">
                            <h3>Taxi Now App<span> screen shots</span></h3>
                            <span class="divider"></span>
                ...
                <div class="row">
                    <div class="col-md-8 col-md-push-2 clearfix">
                        <div class="section-heading scrollpoint sp-effect3">
                            ...
                            <span class="divider"></span>
                            <p>And when you have the itch to contact us, we are right here at <a style="color:#fff;" href="mailto:info@mowares.com" >info@mowares.com.</a> Shoot a mail and we would solve your queries.</p>
                        </div>
                    </div>
                  <div class="col-md-12">
                        <div class="social">
                            <ul>
                                <li><a href="https://twitter.com/mowares"><i class="fa fa-twitter fa-lg"></i></a></li>
                                <li><a href="https://www.facebook.com/MOWARES"><i class="fa fa-facebook fa-lg"></i></a></li>
                            </ul>
                        </div>
                        <p class="rights">
                            2015 <span>Taxi Now</span> Developed by <a href="http://www.mowares.com"><span>Mowares</span></a> | <a href="{{route('termsncondition')}}"><span>Terms and Conditions</span></a>
                        </p>
                    </div>
                </div>
            </div>
